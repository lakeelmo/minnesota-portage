...
import { CLOTHING, getClothing } from "./characters.js?v=race8";
import {
  travelCost,
  applyDamage,
  addScore,
...
import { companionLine, companionTip } from "./companions.js?v=race8";
import { ANIMALS, getAnimal, hasBonus, lockedAnimals } from "./animals.js?v=race8";
import {
  createDigGame,
  digAt,
  createMemoryGame,
